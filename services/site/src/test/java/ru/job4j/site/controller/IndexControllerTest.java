...
class IndexControllerTest {
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        var submitter1 = new SubmitterDTO(1, "submitter1");
        var submitter2 = new SubmitterDTO(2, "submitter2");

        var firstInterview = new InterviewDTO(1, 1, 1, submitter1,
                "interview1", "description1", "contact1",
                "30.02.2024", "09.10.2023", 1);
        var secondInterview = new InterviewDTO(2, 1, 1, submitter2,
